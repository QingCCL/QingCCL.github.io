...
export const commentConfig: CommentConfig = {
	...
	//twikoo评论系统配置
	twikoo: {
		envId: "https://c.qingccl.com",
		// 设置 Twikoo 评论系统语言
		lang: "zh-CN",
		// 是否启用文章访问量统计功能
		visitorCount: true,
		// Twikoo JS 文件地址，支持 CDN 链接
		// 中国推荐1: https://registry.npmmirror.com/twikoo/1.7.15/files/dist/twikoo.min.js
		...
		jsUrl: "https://registry.npmmirror.com/twikoo/1.7.15/files/dist/twikoo.min.js",
	...
	giscus: {
		// 设置 Giscus 评论系统仓库
		repo: "QingCCL/QingCCL.github.io",
		// 设置 Giscus 评论系统仓库ID
		repoId: "R_kgDOTW9bbQ",
		// 设置 Giscus 评论系统分类
		category: "Announcements",
		// 获取 Giscus 评论系统分类ID
		categoryId: "DIC_kwDOTW9bbc4DBGK2",
		// 获取 Giscus 评论系统映射方式
		mapping: "title",
		// 获取 Giscus 评论系统严格模式
		strict: "0",
